  ...
  return (
    <div className="min-h-screen app-surface text-foreground">
      ...
      <main className="px-6 pt-28 pb-12 md:pt-32">
        <section className="mx-auto grid max-w-6xl gap-8 md:grid-cols-[1.2fr_0.8fr] md:gap-10">
          <div className="page-fade-in">
            ...
            <p className="mt-5 max-w-xl text-sm leading-relaxed text-muted-foreground md:text-base">
              Round0 helps you run realistic interviews with AI guidance, then
          ...
          {/* <div className="page-fade-in">
            <div className="soft-grid rounded-3xl border border-border/65 bg-card/72 p-5 shadow-md backdrop-blur-sm md:p-6">
              <p className="text-[11px] uppercase tracking-[0.12em] text-muted-foreground">
                Session highlights
              </p>
              <div className="mt-5 space-y-4">
                {[
                  "Role-aware dynamic questioning",
                  "Voice + coding + whiteboard workflows",
                  "Score trends and guided next actions",
                ].map((item) => (
                  <div
                    key={item}
                    className="flex items-center gap-2.5 rounded-2xl border border-border/55 bg-background/65 p-3.5"
                  >
